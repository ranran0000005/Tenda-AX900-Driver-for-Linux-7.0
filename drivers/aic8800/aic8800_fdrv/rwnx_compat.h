...
/* cfg80211_rx_spurious_frame: 7.0+ requires link_id */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(7, 0, 0)
...
/* cfg80211_put_bss: always use wiphy param on 3.9+ */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3, 9, 0)
#define rwnx_cfg80211_put_bss(wiphy, bss) cfg80211_put_bss(wiphy, bss)
#else
#define rwnx_cfg80211_put_bss(wiphy, bss) cfg80211_put_bss(bss)
#endif
